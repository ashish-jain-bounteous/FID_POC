# Action Spec: SQL Agent — PROJ-101
...
Triage did not route **SQL Agent** for PROJ-101. No action will be taken.

_If it were routed, it would: Implement the SQL (DDL/DML/views) changes called for by the design spec._
