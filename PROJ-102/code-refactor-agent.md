# Action Spec: Code Refactor Agent — PROJ-102
...
This document states — **for review before execution** — exactly what Code Refactor Agent
...
Triage did not route **Code Refactor Agent** for PROJ-102. No action will be taken.

_If it were routed, it would: Refactor existing SQL/Python for readability and standards compliance without changing behavior._

## Inputs
Target source files; standards in .claude/hooks/sql_standards.py

## Output artifact(s)
Refactored, behavior-preserving .sql/.py files
