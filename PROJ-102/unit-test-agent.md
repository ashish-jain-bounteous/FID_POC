# Action Spec: Unit Test Agent — PROJ-102
...
Author unit tests for the feature: SETTLEMENT_DATE = trade date + 2 (incl. the business-day edge case if chosen), non-null after load, and correct exposure in VW_DAILY_POSITIONS.
...
| # | File | Operation |
|---|------|-----------|
| 1 | tests/PROJ-102/test_settlement_date.sql | Create unit-test SQL for T+2 population and view exposure. |
