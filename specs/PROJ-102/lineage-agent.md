# Action Spec: Lineage Agent — PROJ-102
...
Triage did not route **Lineage Agent** for PROJ-102. No action will be taken.

_If it were routed, it would: Trace and document end-to-end lineage for the impacted objects across tables, code and Control-M jobs._

## Inputs
Impacted objects from Triage; snowflake/** and control_m/**

## Output artifact(s)
reports/PROJ-102-lineage.md
