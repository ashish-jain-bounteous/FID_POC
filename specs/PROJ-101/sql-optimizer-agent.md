# Action Spec: SQL Optimizer Agent — PROJ-101
...
Triage did not route **SQL Optimizer Agent** for PROJ-101. No action will be taken.
...
## Output artifact(s)
reports/PROJ-101-sql-optimization.md (+ optional optimized SQL)
