# Action Spec: Code Refactor Agent (Persona: Data Engineer) - PROJ-103

**Agent:** `code-refactor-agent`  ·  Persona: Data Engineer  ·  Pipeline stage: 2 - Build
...
This document states, for review before execution, exactly what Code Refactor Agent (Persona: Data Engineer)
...
## Agent role
Refactors code based on the standards.

## Planned action for PROJ-103
Triage did not route Code Refactor Agent (Persona: Data Engineer) for PROJ-103. No action will be taken.

_If it were routed, it would: Refactors code based on the standards._
