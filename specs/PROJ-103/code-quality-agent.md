# Action Spec: Code Quality Agent (Persona: Finops & Devops) - PROJ-103
...
This document states, for review before execution, exactly what Code Quality Agent (Persona: Finops & Devops)
...
## Agent role
Scans the code for all quality / best practices and fixes the code.

## Planned action for PROJ-103
Triage did not route Code Quality Agent (Persona: Finops & Devops) for PROJ-103. No action will be taken.

_If it were routed, it would: Scans the code for all quality / best practices and fixes the code._
