# Action Spec: Unit Test Agent (Persona: Test Engineer) - PROJ-103

**Agent:** `unit-test-agent`  ·  Persona: Test Engineer  ·  Pipeline stage: 3 - Test
...
This document states, for review before execution, exactly what Unit Test Agent (Persona: Test Engineer)
...
## Agent role
Creates unit test cases based on the spec and code.

## Planned action for PROJ-103
Triage did not route Unit Test Agent (Persona: Test Engineer) for PROJ-103. No action will be taken.

_If it were routed, it would: Creates unit test cases based on the spec and code._
