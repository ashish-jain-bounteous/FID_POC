# Action Spec: Python Agent (Persona: Data Engineer) - PROJ-103

**Agent:** `python-agent`  ·  Persona: Data Engineer  ·  Pipeline stage: 2 - Build
...
This document states, for review before execution, exactly what Python Agent (Persona: Data Engineer)
...
## Agent role
Modifies / creates Python scripts based on the spec.

## Planned action for PROJ-103
Triage did not route Python Agent (Persona: Data Engineer) for PROJ-103. No action will be taken.

_If it were routed, it would: Modifies / creates Python scripts based on the spec._
