# Action Spec: Data Product Agent (Persona: Product Owner) - PROJ-103
...
This document states, for review before execution, exactly what Data Product Agent (Persona: Product Owner)
...
## Agent role
Defines the parameters / metadata for a data product (owner, SLAs, schema contract, classification).

## Planned action for PROJ-103
Triage did not route Data Product Agent (Persona: Product Owner) for PROJ-103. No action will be taken.

_If it were routed, it would: Defines the parameters / metadata for a data product (owner, SLAs, schema contract, classification)._
