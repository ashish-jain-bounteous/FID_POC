# Action Spec: Regression Test Agent (Persona: Test Engineer) - PROJ-103
...
This document states, for review before execution, exactly what Regression Test Agent (Persona: Test Engineer)
...
## Agent role
Identifies all unit test cases for that code and updates the catalog for the future regression suite.

## Planned action for PROJ-103
Triage did not route Regression Test Agent (Persona: Test Engineer) for PROJ-103. No action will be taken.

_If it were routed, it would: Identifies all unit test cases for that code and updates the catalog for the future regression suite._
