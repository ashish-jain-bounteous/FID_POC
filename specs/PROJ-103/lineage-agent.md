# Action Spec: Lineage Agent (Persona: Product Owner) - PROJ-103

**Agent:** `lineage-agent`  ·  Persona: Product Owner  ·  Pipeline stage: 1 - Analysis
...
This document states, for review before execution, exactly what Lineage Agent (Persona: Product Owner)
...
## Agent role
Creates a detailed lineage report of the impacted objects (tables / code / jobs).

## Planned action for PROJ-103
Triage did not route Lineage Agent (Persona: Product Owner) for PROJ-103. No action will be taken.

_If it were routed, it would: Creates a detailed lineage report of the impacted objects (tables / code / jobs)._
