# Action Spec: SQL Agent (Persona: Data Engineer) - PROJ-103
...
This document states, for review before execution, exactly what SQL Agent (Persona: Data Engineer)
...
## Agent role
Modifies / creates SQL scripts based on the spec.

## Planned action for PROJ-103
Triage did not route SQL Agent (Persona: Data Engineer) for PROJ-103. No action will be taken.

_If it were routed, it would: Modifies / creates SQL scripts based on the spec._
